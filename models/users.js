...
userModel.seed = function(){
	var defaultUser = new User({username:'ali', password:'5f4dcc3b5aa765d61d8327deb882cf99', activeSession:'emeka'});
...
userModel.saveUser = function(username, password) {
	...
	var results = q.defer();
	var defaultUser = new User(user_data);
	...
	defaultUser.save(function(err, user) {
		...
		if (err)
		{
			results.reject({
				"status"	: 400,
				"message" 	: "username or password exist :("
			})
		}
