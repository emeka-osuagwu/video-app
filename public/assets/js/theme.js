...
var theme = function () {
    ...
    function resizePage() {
        ...
        $('#testimonials').trigger('refresh');
         $('.person-speaker2 .owl-carousel').trigger('refresh');
    ...
    return {
        ...
        initCountDown: function () {
            ...
            austDay = new Date(austDay.getFullYear() +0, 10 - 1, 25);
        ...
        initGoogleMap: function() {
            ...
            function initialize() {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 12,
                    center: new google.maps.LatLng(6.607408, 3.359227) // map coordinates
                };
                map = new google.maps.Map(document.getElementById('map-canvas'),
                    mapOptions);
                marker = new google.maps.Marker({
                    position: new google.maps.LatLng(6.607408, 3.359227), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Hello World!'
                });
