    ...
    <div class="content-area">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span>Classique Event Centre, 7a Kudirat Abiola Way Oregun, Lagos Nigeria</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-2">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">Attendants</h4>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span>19 Professional Instructors</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <h1 class="section-title">
                    ...
                    <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">The Biggest Cake Exhibition in Africa <small>/ There's something for everyone</small></span>
                </h1>
                <div class="row">
                    <div class="col-lg-8">
                ...
                <div class="schedule-wrapper clear" data-animation="fadeIn" data-animation-delay="200">
                    <div class="schedule-tabs lv1">
                        <ul id="tabs-lv1"  class="nav nav-justified">
                            <li class="active"><a href="#tab-first" data-toggle="tab"><strong>Day 01</strong> <br/>25.10.2017</a></li>
                            <li><a href="#tab-second" data-toggle="tab"><strong>Day 02</strong> <br/>26.10.2017</a></li>
                            <li><a href="#tab-cart" data-toggle="tab"><strong>Check Out</strong> <br/>and make payment</a></li>
                        </ul>
                    </div>

                    <div class="tab-content lv1">
                        <!-- tab1 -->
                        <div id="tab-first" class="tab-pane in active">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv21"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv21-first" data-toggle="tab">Room 1</a></li>
                                    <li><a href="#tab-lv21-second" data-toggle="tab">Room 2</a></li>
                                </ul>
                            </div>
                            <div class="tab-content lv2">
                                <div id="tab-lv21-first" class="tab-pane fade in active">
                                    <div class="timeline">
                                        @foreach($data->where('day', 1)->where('class', 1) as $class)
                                            @include('classes')
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <div id="tab-second" class="tab-pane fade">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv22"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv22-first" data-toggle="tab">Room 1</a></li>
                                    <li><a href="#tab-lv22-second" data-toggle="tab">Room 2</a></li>
                                </ul>
                            </div>
                            <div class="tab-content lv2">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        <div class="post-meta">
                                                            <span class="post-date"><i class="fa fa-clock-o"></i> 16:00 - 17:00</span>
                                                        ...
                                                        <h2 class="post-title"><a href="#">Business Class Course: Pricing And Standing Out In A Competitive Market</a></h2>
                                                    </div>
                                                    <div class="post-body">
                        ...
                        <!-- tab-cart -->
                        <div id="tab-cart" class="tab-pane fade">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv22"  class="nav nav-justified">
        ...
        <section class="page-section light" id="speakers">
            <div class="container">
                ...
                <!-- Speakers row -->
                <div id="person-speaker" class="row thumbnails clear person-speaker2">
                        ...
                        <div class="thumbnail no-border no-padding text-center">
                            ...
                            <div class="caption before-media">
                                <h3 class="caption-title">Tosan Jemide</h3>
                    ...
                    <!-- -->
                        ...
                        <div class="thumbnail no-border no-padding text-center">
                            ...
                            <div class="caption before-media">
                                <h3 class="caption-title">Siku Adewuyi</h3>
                    ...
                    <!-- -->
                        ...
                        <div class="thumbnail no-border no-padding text-center">
                            ...
                            <div class="caption before-media">
                                <h3 class="caption-title">Tarela Okene</h3>
    ...
    <footer class="footer">
        <div class="footer-meta">
            <div class="container text-center">
                ...
                <span class="copyright" data-animation="fadeInUp" data-animation-delay="100">&copy; 2017 Kogsy Sugarcraft &#8212; </span>
            </div>
        </div>
    </footer>
    <!-- /FOOTER -->
